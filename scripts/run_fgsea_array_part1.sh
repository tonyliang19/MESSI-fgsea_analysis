...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=fgsea_array_part1
#SBATCH --array=1-80%25
#SBATCH --cpus-per-task=2
#SBATCH --mem=4G
#SBATCH --output=logs/fgsea_part1_%A/job_%a.out
#SBATCH --error=logs/fgsea_part1_%A/job_%a.err
...
INPUT_FILE="fgsea_part1_inputs.tsv"
